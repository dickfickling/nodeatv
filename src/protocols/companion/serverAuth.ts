/**
 * Server-side authentication for Companion protocol.
...
export abstract class CompanionServerAuth {
	...
	abstract sendToClient(data: Record<string, unknown>): Promise<void>;
	...
	private _pairSetupM5(tlv: Map<number, Buffer>): Buffer {
		...
		const serverId = Buffer.from("CompanionServerAuth");
